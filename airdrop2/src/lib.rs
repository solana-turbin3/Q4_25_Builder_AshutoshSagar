...
mod tests {
    ...
    fn transfer_sol() {
        ...
        let to_pubkey = Pubkey::from_str("GEyHu2gJiQsKVZAdd33gqgpG22jFrTcKgZGBxkLCzKi1").unwrap();
    ...
    fn enroll_turbin3() {
        ...
        let turbin3_prereq_program = Pubkey::from_str("TRBZyQHB3m68FGeVsqTK39Wm4xejadjVhP5MAZaKWDM")
            .unwrap();
        ...
        println!("\nCongratulations! You've completed the Turbin3 Rust Prerequisites!");
    }
}
